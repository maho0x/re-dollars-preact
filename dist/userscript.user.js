...
(function () {
  ...
  async function fetchGalleryMedia(offset = 0, limit = 50) {
    const res = await fetch(
  ...
  function UserAvatar({ uid, src, nickname, className = "" }) {
    ...
    const handleShortClick = (e) => {
      ...
      showProfileCard(profileUid, e.target);
    };
          ...
          children: /* @__PURE__ */ u$2("div", { class: "gallery-grid", ref: gridRef, onScroll: handleScroll, children: [
            items.value.map((item, idx) => /* @__PURE__ */ u$2(
              "div",
              {
                ...
                ] }) : /* @__PURE__ */ u$2(ee, { src: item.url, children: /* @__PURE__ */ u$2("img", { src: item.thumbnailUrl || item.url, alt: "", loading: "lazy" }) })
              },
              `${item.message_id}-${idx}`
            )),
